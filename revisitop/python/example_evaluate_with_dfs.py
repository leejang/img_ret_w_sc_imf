...
sc_imf_ranks = sc_imf(qsim, Wn, alpha)

alg_names = ['Plain', 'Diffusion cg', 'Diffusion trunkated',  'Spectral R=2000', 'DFS+SC-IMF']
alg_ranks = [plain_ranks, cg_ranks, cg_trunk_ranks,  fast_spectral_ranks, sc_imf_ranks]
