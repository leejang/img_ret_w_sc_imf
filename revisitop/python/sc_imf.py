...
# roxford
#f = 'roxf_dfs.npy'
#gnd_fname = '/app/cnnimageretrieval-pytorch/data/test/roxford5k/gnd_roxford5k.pkl' 
...
"""
def sc_imf(qsims, Wn, alpha = 0.99, maxiter = 10, tol = 1e-3):
...
def sc_imf(qsims, Wn, alpha = 0.99, maxiter = 10, tol = 1e-3):
    ...
    ranks = np.argsort(-new_scores, axis = 0)
    return ranks
